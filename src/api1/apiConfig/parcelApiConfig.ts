...
export const parcelApiUrl: any = {
  ...
  //	非邮寄退回报表数据
  GetNoMailReturnGoodsReportPageList: config.MsHost + "api/MsExpressCommon/GetNoMailReturnGoodsReportPageList",
  //	物流发货统计报表
  GetLogisticsExpressStatisticsReport: config.MsHost + "api/MsExpressCommon/GetLogisticsExpressStatisticsReport",
  //		物流接收包裹明细列表
  ...
  //	非货品发出-提交
  BatchUpdateNoGoodsExpressFreight: config.MsHost + "api/MsNoGoods/BatchUpdateNoGoodsExpressFreight",
  //	非货品发出-调用excel公共方法导入数据获得数据够，马上调用下面接口获取导入的数据
  BatchGetNoGoodsExpressReceiveList: config.MsHost + "api/MsNoGoods/BatchGetNoGoodsExpressReceiveList",
  //	接收-退回
  ...
  // 	包裹转交列表
  GetLogisticsGroupPageListByTransfer: config.MsHost + "api/MsLogisticsGoods/GetLogisticsGroupPageListByTransfer",
  // 	转交包裹
  ...
  //		包裹管理列表
  GetLogisticsGroupPageListByManage: config.MsHost + "api/MsLogisticsGoods/GetLogisticsGroupPageListByManage",
  //	包裹退回
  ...
  //发货快递列表
  GetLogisticsExpressPageListBySend: config.MsHost + "api/MsLogisticsGoods/GetLogisticsExpressPageListBySend",
  //		收货快递列表
  GetLogisticsExpressPageListByReceive: config.MsHost + "api/MsLogisticsGoods/GetLogisticsExpressPageListByReceive",
  //	物流取消快递
  ...
  //	收取包裹列表
  GetLogisticsGroupPageListByCollect: config.MsHost + "api/MsLogisticsGoods/GetLogisticsGroupPageListByCollect",
  //	收取包裹
  ...
  //	凭证入库查询
  GetLogisticsReceiptCertPageList: config.MsHost + "api/MsLogisticsGoods/GetLogisticsReceiptCertPageList",
  ...
  //分页获取物流调拨明细列表  
  GetLogisticsAllocationDetailList: config.MsHost + "api/MsBackAndAlloctaion/GetLogisticsAllocationDetailList",
  //获取门店调拨明细列表  
  GetShopAllocationDetailList: config.MsHost + "api/MsBackAndAlloctaion/GetShopAllocationDetailList",
