...
export default {
  ...
  GetEmployeeInfo: async function (param: any) {
    let result = await httpClient.Post(baseApiConfig.LoginAsync, param);
    return result;
  },
  ...
  GetBankInfoByCardNum: async function (param: any) {
    let result = await httpClient.Post(
      baseApiConfig.GetBankInfoByCardNum,
      param
    );
    return result;
  },
  ...
  async GetDataElementList(domainCode: string) {
    let result = await httpClient.Post(baseApiConfig.GetDataElementList, {
  ...
  GetDataTable: async function (param: any) {
    let result = await httpClient.Post(baseApiConfig.GetDataTable, {
      queryParam: param
    });
    let resultData: any = result.Data;
    let list: any = [];
  ...
  GetPageList: async function (pageModel: any) {
    let result = await httpClient.Post(baseApiConfig.GetPageList, {
      Model: pageModel
    });
    return result;
  },
   ...
   */
  GetRtsMenu: async function (
    ueid: string,
    shopCode: string,
  ) {
    let result = await httpClient.Post(baseApiConfig.GetRtsMenu, {
      UEID: ueid,
      ShopCode: shopCode,
      PlatformType: 'pc'
    });
  ...
  GetBillNumber: async function (billCode: string, num: number) {
    let result = await httpClient.Post(baseApiConfig.GetBillNumber, {
      BillCode: billCode,
      Num: num
    });
    return result;
  ...
  GetProvinceCityAreaTreeData: async function () {
    let result = await httpClient.Post(
      baseApiConfig.GetProvinceCityAreaTreeData,
      {}
    );
    return result;
  },
  ...
  async UpdateShopLocation(
    ...
    let result = await httpClient.Post(baseApiConfig.UpdateShopLocation, {
      shopCode: shopCode,
      address: address,
      lat: lat,
      lng: lng,
  ...
  async GetEmpByShopCode(shopCode: string) {
    let result = await httpClient.Post(baseApiConfig.GetEmpByShopCode, {
      shopCode: shopCode
    });
    return result;
  },
   ...
   */
  async GetProvinces() {
    let result = await httpClient.Post(baseApiConfig.GetProvinces, {});
    return result;
  },
  /**
   *获取门店信息
   ...
   * @returns
   */
  async GetProvinceShopList(provinceCode: string, cityCode: string, typeCodeList: string[], shopCode: string) {
    var shopCodeList: any = []
    if ((store as any).state.commonStore.isLoading) {
      return
    }
    store.commit('setLoading', { text: '获取门店信息中...', isLoading: true });
    let result: any = await httpClient.Post(baseApiConfig.GetProvinceShopList, {
      req: {
 ...
 */
  async GetReceiverList() {
    ...
    var shopCodeList: any = []
    let result: any = await httpClient.Post(parcelApiUrl.GetReceiverList, {
    });
    if (result.Success) {
      if (result.Data) {
        if (result.Data.Data) {
...
*/
  async GetUpdateInfo() {
    ...
    let result = await httpClient.Post(baseApiConfig.GetUpdateInfo, {
