  ...
  <div class="h-full">
    ...
    >
      ...
      <div class="flex items-center justify-between">
        <img name="minus-small" class="h-6" src="/src/assets/images/men/minus-small.png" alt="" />
        <div class="px-3">{{ viewNum }}</div>
        <img name="add-small" class="h-6" src="/src/assets/images/men/add-small.png" alt="" />
      </div>
      <div class="flex">
        <img name="rotate" class="h-6 pr-5" src="/src/assets/images/men/rotate.png" alt="" />
        <img
          name="OriginalSize"
          class="h-6 pr-5"
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const viewflag = reactive({
        preview: route.path == '/auditList/index' ? 'check' : 'default',
      });
