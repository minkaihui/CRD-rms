<template>
   <div :class="!getShowTag ? 'mkh' : ''">
     ...
     <span :class="getTagClass" style="background-color: rgba(0, 0, 0, 0);" v-if="!getShowTag && items.icon=='ant-design:plus-outlined'" @click="openModal"><Icon :icon="items.icon"></Icon></span>
